...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('hairskinquiz');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Albatool\HairSkinQuiz\Model\Hairskinquiz')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('hairskinquiz/*/index');
    }

...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('ingredientsglossary');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Albatool\Ingredients\Model\Ingredientsglossary')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('ingredients/*/index');
    }

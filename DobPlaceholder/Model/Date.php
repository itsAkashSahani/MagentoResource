...
namespace Albatool\DobPlaceholder\Model;
...
class Date extends \Magento\Framework\View\Element\Html\Date
{
    ...
    {
        $html = '<input placeholder="' . __("Date of birth (dd/mm/yy)") . '" type="text" name="' . $this->getName() . '" id="' . $this->getId() . '" ';
        $html .= 'value="' . $this->escapeHtml($this->getValue()) . '" title="' . __("Date of birth (dd/mm/yy)") . '"';

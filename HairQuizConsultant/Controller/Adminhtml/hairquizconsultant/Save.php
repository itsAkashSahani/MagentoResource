...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Albatool\HairQuizConsultant\Model\Hairquizconsultant\Image $imageModel
    )
    {
    ...
    public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Albatool\HairQuizConsultant\Model\Hairquizconsultant');
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Hairquizconsultant has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Hairquizconsultant.'));
            }

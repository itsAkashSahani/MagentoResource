...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('hairquizconsultant');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Albatool\HairQuizConsultant\Model\Hairquizconsultant')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('hairquizconsultant/*/index');
    }

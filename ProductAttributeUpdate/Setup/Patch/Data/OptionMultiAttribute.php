...
class OptionMultiAttribute implements DataPatchInterface
{
...
public function apply()
{
    ...
    $fileName = 'albatoolmultioption.csv';
    //$this->_dir->getPath('pub');
    $pubPath = $this->_dir->getDir('Albatool_ProductAttributeUpdate', Dir::MODULE_SETUP_DIR) . "/CsvFiles/albatoolmultioption.csv";

...
class AllOptionMultiAttribute implements DataPatchInterface
{
...
public function apply()
{
    ...
    $fileName = 'allmultioption.csv';
    //$this->_dir->getPath('pub');
    $pubPath = $this->_dir->getDir('Albatool_ProductAttributeUpdate', Dir::MODULE_SETUP_DIR) . "/CsvFiles/allmultioption.csv";

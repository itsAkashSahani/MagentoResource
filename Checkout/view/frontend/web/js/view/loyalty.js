define([
    ...
    return Component.extend({
        ...
        defaults: {
            template: 'Albatool_Checkout/loyalty'
        },
         /**
                       ...
                       console.log("mobilenumber====>"+mobilenumber);
                        $.ajax({
                                ...
                                success : function(response)
                                {
                                    ...
                                    $("#label_loyalty_txt").append($t("Loyalty points"));
                            ...
                            //alert(localStorage.getItem("selfpoint"));
                    ...
                    var linkUrl = url.build('customer/index/loyalty');
                        if($(this).prop("checked") == true){
                             $.ajax({
                                ...
                                {
                                    console.log(response);
                                    $(".loyalty_points_error_msg").html($t("no loyalty points available in your account"));
